...
static NSString *serviceName = @"com.hopever.zhimalegou";
...
+ (BOOL)createKeychainNSStringValue:(NSString *)value forIdentifier:(NSString *)identifier
{
    ...
    if (status == errSecSuccess) {
        ...
        return [self updateKeychainNSStringValue:value forIdentifier:identifier];
    }
    else {
        return NO;
    }
...
+ (BOOL)createKeychainDataValue:(NSData *)value forIdentifier:(NSString *)identifier
{
    ...
    if (status == errSecSuccess) {
        ...
        return [self updateKeychainDataValue:value forIdentifier:identifier];
    }
    else {
        return NO;
    }
